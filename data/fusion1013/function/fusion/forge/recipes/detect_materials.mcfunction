...
execute as @e[tag=fc_material,tag=fc_diamond_block] at @s if block ~ ~-1 ~ chiseled_deepslate if entity @e[type=item,nbt={Item:{id:"minecraft:diamond_block",count:1}}] run scoreboard players set @s forge 1
execute as @e[tag=fc_material,tag=fc_diamond_block] at @s unless entity @e[type=item,nbt={Item:{id:"minecraft:diamond_block",count:1}}] run scoreboard players set @s forge 0
...
## MOLD PILLARS
# BLADE MOLD
execute as @e[tag=fc_mold,tag=fc_blade_mold] at @s if block ~ ~-1 ~ anvil if entity @e[type=item,nbt={Item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"thegreatwork:forge/mold_blade"}}}] run scoreboard players set @s forge 1
execute as @e[tag=fc_mold,tag=fc_blade_mold] at @s unless entity @e[type=item,nbt={Item:{id:"minecraft:clock",count:1,components:{"minecraft:item_model":"thegreatwork:forge/mold_blade"}}}] run scoreboard players set @s forge 0

...
execute positioned ~ ~ ~ rotated 0 0 run cparticle display circle minecraft:enchant 5 10 true
...
execute as @e[type=item,distance=..5,nbt={Item:{id:"minecraft:iron_block"}}] run particle end_rod ~ ~ ~ .1 .1 .1 0 1
execute as @e[type=item,distance=..5,nbt={Item:{id:"minecraft:copper_block"}}] run particle end_rod ~ ~ ~ .1 .1 .1 0 1
execute as @e[type=item,distance=..5,nbt={Item:{id:"minecraft:gold_block"}}] run particle end_rod ~ ~ ~ .1 .1 .1 0 1

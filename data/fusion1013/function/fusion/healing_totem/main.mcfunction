...
execute as @a[scores={healing_totem=80}] at @s run effect give @s health_boost 300 0 true
...
execute as @a[scores={healing_totem=120}] at @s run effect give @s health_boost 300 0 true
...
execute as @a[scores={healing_totem=160}] at @s run effect give @s health_boost 300 0 true
...
execute as @a[scores={healing_totem=200}] at @s run effect give @s health_boost 300 0 true

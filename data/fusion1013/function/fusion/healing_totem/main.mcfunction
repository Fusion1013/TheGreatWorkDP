...
execute as @a[scores={healing_totem=80}] at @s run effect give @s health_boost 300 1 true
...
execute as @a[scores={healing_totem=120}] at @s run effect give @s health_boost 300 2 true
...
execute as @a[scores={healing_totem=160}] at @s run effect give @s health_boost 300 3 true
...
execute as @a[scores={healing_totem=200}] at @s run effect give @s health_boost 300 4 true

...
execute if score craft_timer primordial_forge matches 80 as @e[tag=pforge_south] at @s run particle end_rod ~ ~ ~ 0 0 0 1 100 force
execute if score craft_timer primordial_forge matches 80 as @e[tag=pforge_south] at @s run playsound minecraft:entity.illusioner.prepare_blindness block @a

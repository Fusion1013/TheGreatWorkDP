...
execute as @e[tag=item_sacrifice,scores={item_detector=1}] at @s as @e[type=item,distance=..0.5] run function fusion1013:fusion/common/item_sacrifice/consume_item